export const sampleTermsConditions = `
  <p>
    Welcome to poshax.shop also hereby known as &quot;we&quot;,
    &quot;us&quot; or &quot;PoshaX&quot;. Please read these Terms &
    ...
    this Site. This Site is owned and operated by PoshaX. (Registration
  ...
  <h2>Introduction</h2>
  <p>
    The domain name poshax.shop (referred to as &quot;Website&quot;)
    is owned by &quot;PoshaX&quot; a company incorporated under the
  ...
  <p>
    ...
    account. You agree to (a) immediately notify poshax.shop of any
    ...
    each session. poshax.shop shall not be liable for any loss or damage
    arising from your failure to comply with the T&C.
  </p>
  <h2>Services</h2>
  <p>
    poshax.shop provides a number of Internet-based services through the
    Web Site (all such services, collectively, the &quot;Service&quot;). One
    such service enables users to purchase custom merchandise from
    PoshaX and various sellers.(Collectively, &quot;Products&quot;). The
    Products can be purchased through the Website through various methods of
    payments offered. Upon placing an order, poshax.shop shall ship the
  ...
  <p>
    ...
    fully understands the Privacy Policy of poshax.shop. The user further
  ...
  <p>
    ...
    the content of the Website is permitted provided that PoshaX&apos;s
    name is stated as the source and prior written permission of
    poshax.shop is sought. For the removal of doubt, it is clarified that
