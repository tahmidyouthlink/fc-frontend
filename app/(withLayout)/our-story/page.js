...
//     staff: {
//       name: "John Doe",
//       imgSrc: "/story/staff/1.jpg",
//       comments:
//         "<p>The website has a <span>huge potential</span> to change the <span>fashion e-commerce</span> space.</p><p>Our team is working <span>tirelessly</span> to make it happen, and I'm <span>excited</span> for what's to come.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a02",
...
//     staff: {
//       name: "Alice Smith",
//       imgSrc: "/story/staff/2.jpg",
//       comments:
//         "<p>Our <span>development team</span> is ensuring the website is as <span>fast</span> as it is <span>beautiful</span>.</p><p>We're focusing on making sure it's a <span>smooth experience</span> for users no matter their <span>device</span>.</p><p>It's an <span>exciting challenge</span> to <span>optimize</span> every feature to <span>perfection</span>!</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a03",
...
//     staff: {
//       name: "Rachel Green",
//       imgSrc: "/story/staff/3.jpg",
//       comments:
//         "<p><span>Fashion</span> is all about <span>expression</span>, and our website design reflects that.</p><p>We've worked hard to make sure every page feels as <span>stylish</span> as our <span>clothes</span>.</p><p>Our design is about making an <span>impact</span> the moment someone lands on the site.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a04",
...
//     staff: {
//       name: "Mark Johnson",
//       imgSrc: "/story/staff/4.jpg",
//       comments:
//         "<p>We're always looking for the <span>next big trend</span>. <span>Fashion</span> is fast-paced, and we ensure we stay <span>ahead</span> of the curve.</p><p>It's <span>thrilling</span> to see our <span>collection</span> come to life on the website.</p><p>Every item we select is chosen with <span>care</span> and <span>precision</span>.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a05",
...
//     staff: {
//       name: "Sophia Carter",
//       imgSrc: "/story/staff/5.jpg",
//       comments:
//         "<p>It's an <span>exciting time</span> for <span>fashion</span>, and our role is to bring the <span>freshest trends</span> to our customers.</p><p>Our team works hard to ensure that what you see online is the <span>latest</span> and <span>greatest</span>.</p><p>We're all about <span>setting the trend</span>, not just following it.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a06",
...
//     staff: {
//       name: "Liam Davis",
//       imgSrc: "/story/staff/6.jpg",
//       comments:
//         "<p><span>Marketing</span> is all about <span>connecting</span> with people, and we're focused on making sure we reach those who will love our <span>fashion</span>.</p><p>Through <span>creative campaigns</span>, we're making sure the world knows about our <span>brand</span>.</p><p>Our job is to ensure that <span>fashion lovers</span> find us wherever they are.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a07",
...
//     staff: {
//       name: "Ethan Wright",
//       imgSrc: "/story/staff/7.jpg",
//       comments:
//         "<p>The <span>integration</span> of <span>dynamic content</span> is key to enhancing the <span>user experience</span>.</p><p>Our job is to ensure everything <span>runs smoothly</span>, especially with features like <span>product galleries</span> and animations.</p><p>A <span>seamless experience</span> is vital for keeping <span>customers engaged</span>.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a08",
...
//     staff: {
//       name: "Olivia Brown",
//       imgSrc: "/story/staff/8.jpg",
//       comments:
//         "<p><span>Customer service</span> is about building <span>trust</span> and providing help when needed the most.</p><p>We're always ready to <span>assist</span> our customers, ensuring they have the <span>best experience</span> with us.</p>",
//     },
//   },
//   {
//     _id: "661cbf3f1b2c4d001c7e1a09",
...
//     staff: {
//       name: "Michael Lee",
//       imgSrc: "/story/staff/9.jpg",
//       comments:
//         "<p>Behind the scenes, we're ensuring that everything <span>arrives on time</span> and in <span>perfect condition</span> for our customers.</p><p><span>Logistics</span> is a crucial part of the <span>customer experience</span>, and we take it seriously.</p><p>We work hard to make sure every <span>order</span> reaches its <span>destination</span> without a hitch.</p>",
//     },
//   },
// ];
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="fixed left-[5%] top-[25%] size-64 animate-blob rounded-full bg-[#f8dfcb] mix-blend-multiply blur-[32px] max-sm:hidden" />
        <div className="fixed left-[30%] top-[60%] size-64 animate-blob rounded-full bg-[#d7f8d3] mix-blend-multiply blur-[32px] [animation-delay:1.5s]" />
        <div className="fixed left-[55%] top-[5%] size-64 animate-blob rounded-full bg-[#f8dfcb] mix-blend-multiply blur-[32px] [animation-delay:0.5s] sm:bg-[#d7f8d3]" />
        <div className="fixed left-[80%] top-[70%] size-64 animate-blob rounded-full bg-[#f8dfcb] mix-blend-multiply blur-[32px] [animation-delay:2s] max-sm:hidden" />
      </div>
      {!selectedDept ? (
        <StoryHero
          gsap={gsap}
