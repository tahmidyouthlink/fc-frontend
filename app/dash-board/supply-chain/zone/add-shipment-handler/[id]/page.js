  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (res.data.modifiedCount > 0) {
        ...
        router.push('/dash-board/supply-chain/zone/add-shipping-zone');
      } else {
    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <div className='max-w-screen-xl mx-auto pt-3 md:pt-6 px-6'>
        <div className='flex items-center justify-between'>
          ...
          <Link className='flex items-center gap-2 text-[10px] md:text-base justify-end w-full' href={"/dash-board/supply-chain/zone/add-shipping-zone"}> <span className='border border-black hover:scale-105 duration-300 rounded-full p-1 md:p-2'><FaArrowLeft /></span> Go Back</Link>
        </div>
      </div>
