  ...
  return (
    <div className='px-6 md:px-10'>
      <div className="bg-white sticky top-0 z-10">
        ...
        ${activeTab === 'completed' ? 'text-green-600 font-semibold' : 'text-neutral-400 font-medium'}
      ...
      `}
          ...
          <button
            className={`relative text-sm py-1 transition-all duration-300
        ${activeTab === 'refunded' ? 'text-green-600 font-semibold' : 'text-neutral-400 font-medium'}
