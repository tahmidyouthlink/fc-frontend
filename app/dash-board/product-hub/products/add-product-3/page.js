...
`}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='max-w-screen-2xl mx-auto min-h-[85vh] flex flex-col justify-between relative'>
        ...
        <div className='flex justify-between px-6 2xl:px-0 py-6'>
          <Link href='/dash-board/product-hub/products/add-product-2' className='relative z-[1] flex items-center gap-x-3 rounded-lg bg-[#ffddc2] px-[15px] py-2.5 transition-[background-color] duration-300 ease-in-out hover:bg-[#fbcfb0] font-bold text-[14px] text-neutral-700'>
