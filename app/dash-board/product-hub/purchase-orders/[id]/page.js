    ...
    <div className='bg-gray-50 min-h-screen px-6'>
      ...
      ${purchaseOrderStatus === "pending" ? "bg-yellow-100 text-yellow-600"
          ...
          <div className='flex justify-between md:justify-end gap-4 items-center w-full'>
            <Link className='flex items-center gap-2 text-[10px] md:text-base justify-end' href={"/dash-board/product-hub/purchase-orders"}> <span className='border border-black hover:scale-105 duration-300 rounded-full p-1 md:p-2'><FaArrowLeft /></span> Go Back</Link>
