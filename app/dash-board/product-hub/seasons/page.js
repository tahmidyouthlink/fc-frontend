...
const Seasons = () => {
  ...
  const handleGoToSeasonPage = (id) => {
    router.push(`/dash-board/product-hub/seasons/${id}`);
  };
  ...
  return (
    <div className='bg-gray-50 min-h-[calc(100vh-60px)] relative'>
      ...
      <div className='sticky top-0 z-10 bg-gray-50 flex items-center justify-between max-w-screen-2xl mx-auto px-6 py-6'>
        ...
        {isAuthorized &&
          <button onClick={() => router.push('/dash-board/product-hub/seasons/add-season')} className="relative z-[1] flex items-center gap-x-3 rounded-lg bg-[#ffddc2] px-[15px] py-2.5 transition-[background-color] duration-300 ease-in-out hover:bg-[#fbcfb0] font-bold text-[14px] text-neutral-700">
