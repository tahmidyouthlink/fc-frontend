  ...
  return (
    ...
    >
      ...
      <div className="!mt-7 space-y-4">
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-[#d4ffce] py-2.5 text-xs font-semibold text-neutral-700 transition-[background-color] duration-300 hover:bg-[#bdf6b4] md:text-sm"
        >
          Sign up
        </button>
