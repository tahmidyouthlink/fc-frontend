  ...
  return (
    <div className="pt-header-h-full-section-pb min-h-dvh pb-[var(--section-padding)]">
      ...
      <div className="z-[1] mx-5 max-w-[900px] items-stretch overflow-hidden rounded-xl border-2 border-neutral-50/20 bg-white/40 shadow-[0_0_32px_0_rgba(0,0,0,0.0666)] backdrop-blur-2xl sm:mx-8 sm:shadow-[0_0_32px_0_rgba(0,0,0,0.0333)] lg:mx-auto lg:flex">
        {/* Document */}
        <section
          className={`p-5 sm:p-7 xl:p-9 [&_:is(h2,h3)]:mb-2 [&_:is(h2,h3)]:mt-10 [&_h2]:text-xl [&_h3]:text-lg [&_p]:mb-4 [&_p]:text-justify ${!faqs?.length ? "[&_p:last-child]:mb-0" : "[&_p:last-child]:mb-10"}`}
        >
          {/* Texts */}
          <div
