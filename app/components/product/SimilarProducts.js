  ...
  return (
    ...
    >
      ...
      <div className="space-y-5 overflow-hidden px-5 sm:px-8 lg:px-12 xl:mx-auto xl:max-w-[1200px] xl:px-0">
        ...
        <div
          className={`grid-cols-2 gap-x-4 gap-y-12 max-sm:grid ${similarProducts?.length < 6 ? "grid sm:grid-cols-3 lg:grid-cols-4" : "sm:max-lg:[&>div:nth-last-child(2)] sm:flex sm:flex-nowrap sm:transition-transform sm:duration-300 sm:ease-in-out sm:max-lg:[&>div:last-child]:hidden sm:[&>div]:min-w-[calc(33.33%-16px*2/3)] lg:[&>div]:min-w-[calc(25%-16px*3/4)]"} ${isSimilarProductsSlid ? "-translate-x-[calc(100%+16px)]" : "-translate-x-0"}`}
        >
