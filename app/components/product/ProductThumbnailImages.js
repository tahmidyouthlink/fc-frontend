...
export default function ProductThumbnailImages({
  ...
  return (
    <div className="relative sm:max-md:h-[40vh] md:w-80 lg:w-[424px] xl:w-auto xl:max-[1799px]:h-full min-[1800px]:w-[650px]">
          ...
          activeImageSet?.images?.map((imageURL, imageURLIndex) => {
            return (
              ...
              <div
                ...
                className={`relative shrink-0 cursor-pointer overflow-hidden rounded-md bg-[var(--product-default)] transition-[border-color,transform] duration-300 ease-in-out max-sm:aspect-[1/1.2] max-sm:w-[calc((100%-var(--thumbnail-gap)*var(--total-gaps-default))/var(--max-thumbnails-default))] max-sm:translate-x-[calc((100%+var(--thumbnail-gap))*var(--thumbnail-moved))] sm:max-md:aspect-[1/1.1] sm:max-md:h-[calc((100%-var(--thumbnail-gap)*var(--total-gaps-default))/var(--max-thumbnails-default))] sm:max-md:translate-y-[calc((100%+var(--thumbnail-gap))*var(--thumbnail-moved))] md:h-32 md:w-[calc((100%-var(--thumbnail-gap)*var(--total-gaps-small-tablet))/var(--max-thumbnails-small-tablet))] md:max-xl:translate-x-[calc((100%+var(--thumbnail-gap))*var(--thumbnail-moved))] lg:w-[calc((100%-var(--thumbnail-gap)*var(--total-gaps-default))/var(--max-thumbnails-default))] xl:max-[1799px]:aspect-[1/1.25] xl:max-[1799px]:h-[calc((100%-var(--thumbnail-gap)*var(--total-gaps-desktop))/var(--max-thumbnails-desktop))] xl:max-[1799px]:w-full xl:max-[1799px]:translate-y-[calc((100%+var(--thumbnail-gap))*var(--thumbnail-moved))] min-[1800px]:w-[calc((100%-var(--thumbnail-gap)*var(--total-gaps-desktop))/var(--max-thumbnails-desktop))] min-[1800px]:translate-x-[calc((100%+var(--thumbnail-gap))*var(--thumbnail-moved))] ${activeImageIndex === imageURLIndex ? "border-2 border-[var(--color-secondary-darker)]" : ""}`}
      ...
      {/* Previous Nav Button */}
      <button
        className={`absolute flex size-10 items-center justify-center rounded-md bg-white p-0 text-xl shadow-[0_0_12px_0_rgba(0,0,0,0.15)] transition-[background-color,opacity] duration-300 ease-in-out hover:bg-[var(--color-secondary-regular)] max-sm:top-1/2 max-sm:hidden max-sm:-translate-x-2 max-sm:-translate-y-1/2 sm:max-md:left-1/2 sm:max-md:top-0 sm:max-md:-translate-x-1/2 sm:max-md:translate-y-2 md:max-xl:top-1/2 md:max-xl:-translate-x-1/2 md:max-xl:-translate-y-1/2 xl:max-[1799px]:left-1/2 xl:max-[1799px]:top-0 xl:max-[1799px]:-translate-x-1/2 xl:max-[1799px]:translate-y-2 min-[1800px]:top-1/2 min-[1800px]:-translate-x-1/2 min-[1800px]:-translate-y-1/2 [&>svg]:mx-auto ${numOfTimesThumbnailsMoved === 0 ? "pointer-events-none opacity-0" : "pointer-events-auto opacity-100"}`}
        onClick={() =>
      ...
      {/* Next Nav Button */}
      <button
        className={`absolute flex size-10 items-center justify-center rounded-md bg-white p-0 text-xl shadow-[0_0_12px_0_rgba(0,0,0,0.15)] transition-[background-color,opacity] duration-300 ease-in-out hover:bg-[var(--color-secondary-regular)] max-sm:right-0 max-sm:top-1/2 max-sm:hidden max-sm:-translate-y-1/2 max-sm:translate-x-2 sm:max-md:bottom-0 sm:max-md:left-1/2 sm:max-md:-translate-x-1/2 sm:max-md:-translate-y-2 md:max-xl:right-0 md:max-xl:top-1/2 md:max-xl:-translate-y-1/2 md:max-xl:translate-x-1/2 xl:max-[1799px]:bottom-0 xl:max-[1799px]:left-1/2 xl:max-[1799px]:-translate-x-1/2 xl:max-[1799px]:-translate-y-2 min-[1800px]:right-0 min-[1800px]:top-1/2 min-[1800px]:-translate-y-1/2 min-[1800px]:translate-x-2 [&>svg]:mx-auto ${numOfTimesThumbnailsMoved === maxThumbnailsAllowedToMoveDefault ? "pointer-events-none opacity-0 lg:pointer-events-none lg:opacity-0" : "pointer-events-auto opacity-100 lg:pointer-events-auto lg:opacity-100"} ${numOfTimesThumbnailsMoved === maxThumbnailsAllowedToMoveSmallTablet ? "md:pointer-events-none md:opacity-0" : "md:pointer-events-auto md:opacity-100"} ${numOfTimesThumbnailsMoved === maxThumbnailsAllowedToMoveDesktop ? "xl:pointer-events-none xl:opacity-0" : "xl:pointer-events-auto xl:opacity-100"}`}
        onClick={() =>
          setNumOfTimesThumbnailsMoved((prevNumber) => prevNumber + 1)
        }
      >
